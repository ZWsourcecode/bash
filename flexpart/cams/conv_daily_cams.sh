...
do
    ...
    cdo -z zip_6 -O mergetime CO2_$YEAR*.nc tempfile_merge.nc 
    
    cdo -z zip_6 -O daymean tempfile_merge.nc CO2_daily_$YEAR.nc
    
done
cdo -z zip_6 -O mergetime CO2_daily_*.nc CO2_daily_2017_2020.nc
