...
do
	...
	ncatted -O -a long_name,rtot,o,c,"Plant and soil respiration" $NEWFILENAME
    ...
    cdo -O expr,'rtot=rtot*1000*1000000/12.011/3600' $NEWFILENAME tempfile_unit.nc
    ncatted -a units,rtot,o,c,"micromol/m2/s" tempfile_unit.nc
