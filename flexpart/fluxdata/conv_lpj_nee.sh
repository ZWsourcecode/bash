...
for file in $SOURCE*hnee*2020.nc
do
    echo $file
	...
	ncatted -O -a long_name,nee,o,c,"net ecosystem exchange" $NEWFILENAME
# 	ncatted -a standard_name,dswrf,c,c,surface_downwelling_shortwave_flux $file
    ...
    cdo -O expr,'nee=nee*1000*1000000/12.011/3600' $NEWFILENAME tempfile_unit.nc
    ncatted -a units,nee,o,c,"micromol/m2/s" tempfile_unit.nc
    ...
    if (($YEAR == 2020 )); then
        ...
        cdo -z zip_6 -O setcalendar,standard tempfile_100_leap.nc 
